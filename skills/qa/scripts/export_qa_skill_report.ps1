...
$report.Add('- Shared loader: `skills/qa/scripts/qa_skill_lib.ps1`')
$report.Add("")
$report.Add("## Module Roles")
$report.Add('- Runtime/path/IO: `skills/qa/scripts/modules/qa_runtime.ps1`')
$report.Add('- Prompt bundle: `skills/qa/scripts/modules/qa_prompt_bundle.ps1`')
$report.Add('- Dataset helpers: `skills/qa/scripts/modules/qa_dataset.ps1`')
$report.Add('- QA generation: `skills/qa/scripts/modules/qa_generation.ps1`')
$report.Add('- Validation/reporting: `skills/qa/scripts/modules/qa_validation.ps1`')
$report.Add("")
